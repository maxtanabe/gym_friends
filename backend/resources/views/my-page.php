...
<body class="index-page sidebar-collapse">
  ...
  <div class="wrapper">
    <div class="page-header clear-filter page-header-small" filter-color="orange">
      <div class="page-header-image" data-parallax="true" style="background-image:url('/assets/img/julie.jpg');"></div>
      <div class="container">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="button-container">
          <a href="/" class="btn btn-primary btn-round btn-lg btn-icon" rel="tooltip" title="Let's be ジムフレ??">
      ...
      <div class="text-center">
        ...
        <h5 class="description">プロフィール文</h5>
        <div class="row">
          <div class="space-50"></div>
          <div class="text-center">
            <div class="title">
              <h3 class="title text-center">Aesthetic Photo</h3>
            </div>
            <img src="/assets/img/eni1.jpeg" alt="YOU'RE VEST PIC" style="width:70%"></img>
          </div>
        </div>
      </div>
      ...
      <div class="section section-basic" style="background-image:url('/assets/img/blurred-image-1.jpg');box-shadow: 10px 10px 10px rgba(0,0,0,0.6);">
        <div class="container">
          <h3 class="title text-center">ジムフレ</h3>
          ...
          <div class="text-center mt-2">
            <a class="btn btn-dark mb-1" data-background-color="black" href="/" onclick="">EDIT ジムフレ</a>
          </div>
        </div>
      </div>
      <div class="space-50"></div>
      <div class="section section-basic" style="background-image:url('/assets/img/blurred-image-1.jpg');box-shadow: 10px 10px 10px rgba(0,0,0,0.6);">
        <div class="container">
          <h3 class="title text-center">GYM</h3>
          <div class="row text-center">
            <div class="col-md-2 col-md-offset-5">
              <div class="category">
                <a href="/" style="text-decoration:none;color:black;">
          ...
          <div class="text-center mt-2">
            ...
            <a class="btn btn-dark mb-1" data-background-color="black" href="/" onclick="">EDIT GYM</a>
          </div>
