    ...
    <div class="section section-basic" style="background-image:url('/assets/img/blurred-image-1.jpg');box-shadow: 10px 10px 10px rgba(0,0,0,0.6);">
      <div class="container">
        ...
        <div class="text-center mt-2">
          <a class="btn btn-dark mb-1" data-background-color="black" href="/" onclick="">EDIT MY ジムフレ</a>
        </div>
      </div>
    </div>
    <div class="space-50"></div>
    <div class="section section-basic" style="background-image:url('/assets/img/blurred-image-1.jpg');box-shadow: 10px 10px 10px rgba(0,0,0,0.6);">
      <div class="container">
        ...
        <div class="text-center mt-2">
          ...
          <a class="btn btn-dark mb-1" data-background-color="black" href="/" onclick="">EDIT MY GYM</a>
        </div>
